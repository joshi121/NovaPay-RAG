...
import { Lock, Mail, User as UserIcon, Wallet, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Get started with secure payment handling</p>
        </div>
